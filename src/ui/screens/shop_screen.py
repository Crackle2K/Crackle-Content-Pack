...
_FALLBACK_CATALOG = [
    {"slug": "poke-ball",    "display_name": "Poke Ball",    "category": "Pokeballs",
     "cost": 200,  "description": "Catches Pokemon.",      "effect": {"type": "pokeball"}},
    {"slug": "great-ball",   "display_name": "Great Ball",   "category": "Pokeballs",
     "cost": 600,  "description": "Better catch rate.",    "effect": {"type": "pokeball"}},
    {"slug": "ultra-ball",   "display_name": "Ultra Ball",   "category": "Pokeballs",
     "cost": 1200, "description": "High-grade Ball.",      "effect": {"type": "pokeball"}},
    {"slug": "potion",       "display_name": "Potion",       "category": "Medicine",
     "cost": 300,  "description": "Restores 20 HP.",       "effect": {"type": "heal", "amount": 20}},
    {"slug": "super-potion", "display_name": "Super Potion", "category": "Medicine",
     "cost": 700,  "description": "Restores 50 HP.",       "effect": {"type": "heal", "amount": 50}},
    {"slug": "hyper-potion", "display_name": "Hyper Potion", "category": "Medicine",
     "cost": 1200, "description": "Restores 200 HP.",      "effect": {"type": "heal", "amount": 200}},
    {"slug": "max-potion",   "display_name": "Max Potion",   "category": "Medicine",
     "cost": 2500, "description": "Fully restores HP.",    "effect": {"type": "heal", "amount": "full"}},
    {"slug": "revive",       "display_name": "Revive",       "category": "Medicine",
     "cost": 1500, "description": "Revives a fainted Pokemon.", "effect": {"type": "revive", "amount": "half"}},
    {"slug": "oran-berry",   "display_name": "Oran Berry",   "category": "Berries",
     "cost": 80,   "description": "Restores 10 HP.",       "effect": {"type": "heal", "amount": 10}},
    {"slug": "sitrus-berry", "display_name": "Sitrus Berry", "category": "Berries",
     "cost": 200,  "description": "Restores 25 HP.",       "effect": {"type": "heal", "amount": 25}},
    {"slug": "lum-berry",    "display_name": "Lum Berry",    "category": "Berries",
     "cost": 250,  "description": "Cures all status.",     "effect": {"type": "heal", "amount": 0}},
    {"slug": "leppa-berry",  "display_name": "Leppa Berry",  "category": "Berries",
     "cost": 150,  "description": "Restores 10 PP.",       "effect": {"type": "pp_restore", "amount": 10}},
]
