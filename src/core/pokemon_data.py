...
POKEMON_DATA = {
    1: {
        ...
        "base_experience": 64, "growth_rate": "medium-slow",
    },
    2: {
        "name": "Ivysaur",
        "types": [PokemonType.GRASS, PokemonType.POISON],
        ...
        "learnable_moves": ["tackle", "vine_whip", "razor_leaf", "solar_beam", "sludge"],
        "base_experience": 142, "growth_rate": "medium-slow",
    },
    3: {
        "name": "Venusaur",
        "types": [PokemonType.GRASS, PokemonType.POISON],
        ...
        "base_experience": 236, "growth_rate": "medium-slow",
    },
    4: {
        "name": "Charmander",
        ...
        "base_experience": 62, "growth_rate": "medium-slow",
    },
    5: {
        "name": "Charmeleon",
        "types": [PokemonType.FIRE],
    ...
    7: {
        ...
        "base_experience": 63, "growth_rate": "medium-slow",
    },
    8: {
        "name": "Wartortle",
        "types": [PokemonType.WATER],
    ...
    9: {
        ...
        "base_experience": 239, "growth_rate": "medium-slow",
    },
    25: {
        "name": "Pikachu",
        ...
        "base_experience": 112, "growth_rate": "medium-fast",
    },
    26: {
        "name": "Raichu",
        "types": [PokemonType.ELECTRIC],
        ...
        "base_experience": 218, "growth_rate": "medium-fast",
    },
    39: {
        "name": "Jigglypuff",
        ...
        "base_experience": 95, "growth_rate": "fast",
    },
    52: {
        "name": "Meowth",
        "types": [PokemonType.NORMAL],
        ...
        "base_experience": 58, "growth_rate": "medium-fast",
    },
    63: {
        "name": "Abra",
    ...
    64: {
        ...
        "base_experience": 140, "growth_rate": "medium-slow",
    },
    65: {
        "name": "Alakazam",
        "types": [PokemonType.PSYCHIC],
        ...
        "base_experience": 225, "growth_rate": "medium-slow",
    },
    74: {
        "name": "Geodude",
        ...
        "base_experience": 60, "growth_rate": "medium-slow",
    },
    94: {
        "name": "Gengar",
    ...
    129: {
        ...
        "base_experience": 40, "growth_rate": "slow",
    },
    130: {
        "name": "Gyarados",
        ...
        "base_experience": 189, "growth_rate": "slow",
    },
    143: {
        "name": "Snorlax",
        "types": [PokemonType.NORMAL],
    ...
    144: {
        ...
        "base_experience": 261, "growth_rate": "slow",
    },
    145: {
        "name": "Zapdos",
    ...
    147: {
        ...
        "base_experience": 60, "growth_rate": "slow",
    },
    148: {
        "name": "Dragonair",
        "types": [PokemonType.DRAGON],
        ...
        "base_experience": 147, "growth_rate": "slow",
    },
    149: {
        "name": "Dragonite",
        ...
        "base_experience": 270, "growth_rate": "slow",
    },
    150: {
        "name": "Mewtwo",
        "types": [PokemonType.PSYCHIC],
        ...
        "base_experience": 306, "growth_rate": "slow",
    },
    151: {
        "name": "Mew",
        "types": [PokemonType.PSYCHIC],
        ...
        "base_experience": 270, "growth_rate": "medium-slow",
    },
}
    ...
    try:
        ...
        if loader.is_data_available():
            ...
            return {
                ...
                "base_experience": loader.get_base_experience(pokemon_id),
                "growth_rate": loader.get_growth_rate(pokemon_id),
            }
